...
@InputType()
class DonationCreateNestedManyWithoutLivestreamsInput {
...
export { DonationCreateNestedManyWithoutLivestreamsInput as DonationCreateNestedManyWithoutLivestreamsInput };
